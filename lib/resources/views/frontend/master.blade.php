                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div id="hotline" class="col-md-3 col-sm-12 col-xs-12">
                            <h3>Hotline</h3>
                            <p>Phone1: (+84) 964289509</p>
                            <p>Phone2: (+84) 964289509</p>
                            <p>Email: 21010596@st.phenikaa-uni.edu.vn</p>
                        </div>
                        <div id="contact" class="col-md-3 col-sm-12 col-xs-12">
                            <h3>Contact Us</h3>
                            <p>Address 1: Đại Học Phenikaa - Hà Đông</p>
                            <p>Address 2: Ngõ 10 Quang Lãm - Hà Đông</p>
                        </div>
                    </div>
                </div>
            </div>
